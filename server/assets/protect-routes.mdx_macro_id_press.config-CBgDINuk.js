...
//#region content/guides/protect-routes.mdx?macro_id=press.config.tsx%23guides
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Protecting a route means rejecting requests that carry no valid session before any handler logic runs. Kwiva gives you guards for controller actions, middleware for request-wide checks, and `beforeLoad` redirects for pages."
		},
		{
			"heading": "prerequisites",
			"content": "Authentication is configured with `defineAuth` and sessions resolve on `ctx.session`"
		},
		{
			"heading": "prerequisites",
			"content": "Your `users` model maps `id`, `email`, and `role`, so `ctx.session.user` is typed"
		},
		{
			"heading": "prerequisites",
			"content": "The `session` middleware is in the global stack in `src/config/app.ts`"
		},
		{
			"heading": "guard-a-controller-action-with-requireauth",
			"content": "`requireAuth` is a `beforeHandle` guard that returns `401` when no user is signed in:"
		},
		{
			"heading": "guard-a-controller-action-with-requireauth",
			"content": "Guard objects compose — chain further checks on the same route, such as `.guard({ beforeHandle: adminOnly })`."
		},
		{
			"heading": "protect-every-request-with-middleware",
			"content": "The framework ships an `auth` middleware with `requireAuth` semantics that returns `401` for anonymous callers. Add it to the middleware stack in `src/config/app.ts`, or define a check of your own:"
		},
		{
			"heading": "protect-pages-with-beforeload",
			"content": "`beforeLoad` receives the session and runs on the server during SSR and again on the client during navigation. Throwing a `redirect` sends guests to `/login` before the loader or component runs:"
		},
		{
			"heading": "raise-the-bar-with-a-policy",
			"content": "Auth checks prove someone is signed in; policies decide what they may do. Give a route a `permission` such as `posts.create` and it is checked against the matching policy before the handler runs. Branch on the same ability inside a handler:"
		},
		{
			"heading": "raise-the-bar-with-a-policy",
			"content": "See How do I add a policy? to define the ability checks these routes rely on."
		},
		{
		...
		{
			"heading": "verify-it-works",
			"content": "Without a session, `curl -i http://localhost:3000/posts/1` returns `401`, and `/account` redirects to `/login`."
		},
		{
			"heading": "verify-it-works",
			"content": "Sign in with `POST /auth/sign-in`, repeat the request with the session cookie, and the handler returns data."
		},
		{
	...
	"headings": [
		...
		{
			"id": "guard-a-controller-action-with-requireauth",
			"content": "Guard a controller action with requireAuth"
		},
		{
			"id": "protect-every-request-with-middleware",
			"content": "Protect every request with middleware"
		},
		{
			"id": "protect-pages-with-beforeload",
			"content": "Protect pages with beforeLoad"
		},
		{
			"id": "raise-the-bar-with-a-policy",
			"content": "Raise the bar with a policy"
		},
		{
			"id": "verify-it-works",
...
var toc = [
	...
	{
		depth: 2,
		url: "#guard-a-controller-action-with-requireauth",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Guard a controller action with requireAuth" })
	},
	{
		depth: 2,
		url: "#protect-every-request-with-middleware",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Protect every request with middleware" })
	},
	{
		depth: 2,
		url: "#protect-pages-with-beforeload",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Protect pages with beforeLoad" })
	},
	{
		depth: 2,
		url: "#raise-the-bar-with-a-policy",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Raise the bar with a policy" })
	},
	{
		depth: 2,
		url: "#verify-it-works",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Protecting a route means rejecting requests that carry no valid session before any handler logic runs. Kwiva gives you guards for controller actions, middleware for request-wide checks, and ",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				...
				" middleware is in the global stack in ",
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "guard-a-controller-action-with-requireauth",
			children: "Guard a controller action with requireAuth"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			...
			tabIndex: "0",
			title: "guard-a-controller-action-with-requireauth.ts",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Guard objects compose — chain further checks on the same route, such as ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: ".guard({ beforeHandle: adminOnly })" }),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "protect-every-request-with-middleware",
			children: "Protect every request with middleware"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"The framework ships an ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "auth" }),
			" middleware with ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "requireAuth" }),
			" semantics that returns ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "401" }),
			" for anonymous callers. Add it to the middleware stack in ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "src/config/app.ts" }),
			", or define a check of your own:"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			...
			tabIndex: "0",
			title: "protect-every-request-with-middleware.ts",
			icon: "<svg viewBox=\"0 0 24 24\"><path d=\"M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.033 5.033 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 27.72 27.72 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.441.58-.804 1.004-1.089a4.494 4.494 0 0 1 1.47-.629 7.536 7.536 0 0 1 1.77-.201zm-15.113.188h9.563v2.166H9.506v9.646H6.789v-9.646H3.375z\" fill=\"currentColor\" /></svg>",
			children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
					className: "line",
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "protect-pages-with-beforeload",
			children: "Protect pages with beforeLoad"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "beforeLoad" }),
			" receives the session and runs on the server during SSR and again on the client during navigation. Throwing a ",
			...
			" before the loader or component runs:"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			...
			tabIndex: "0",
			title: "protect-pages-with-beforeload.tsx",
			...
			children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: "  component: AccountPage,"
					})
				}),
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "raise-the-bar-with-a-policy",
			children: "Raise the bar with a policy"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Auth checks prove someone is signed in; policies decide what they may do. Give a route a ",
			...
			" and it is checked against the matching policy before the handler runs. Branch on the same ability inside a handler:"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			...
			tabIndex: "0",
			title: "raise-the-bar-with-a-policy.ts",
			icon: "<svg viewBox=\"0 0 24 24\"><path d=\"M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.033 5.033 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 27.72 27.72 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.441.58-.804 1.004-1.089a4.494 4.494 0 0 1 1.47-.629 7.536 7.536 0 0 1 1.77-.201zm-15.113.188h9.563v2.166H9.506v9.646H6.789v-9.646H3.375z\" fill=\"currentColor\" /></svg>",
			children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
					className: "line",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			...
			" to define the ability checks these routes rely on."
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "verify-it-works",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"Without a session, ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "curl -i http://localhost:3000/posts/1" }),
				" returns ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "401" }),
				", and ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "/account" }),
				" redirects to ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "/login" }),
				"."
			] }),
			...
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"Sign in with ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "POST /auth/sign-in" }),
				", repeat the request with the session cookie, and the handler returns data."
			] }),
			"\n"
		] }),
		"\n",
