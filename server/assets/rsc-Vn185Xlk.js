import { o as __toESM, t as __commonJSMin } from "./rolldown-runtime-BMI-E3GI.js";
...
//#endregion
//#region node_modules/@vitejs/plugin-rsc/dist/vendor/react-server-dom/cjs/react-server-dom-webpack-server.edge.production.js
...
//#endregion
//#region node_modules/@vitejs/plugin-rsc/dist/vendor/react-server-dom/server.edge.js
	...
	globalThis.__vite_rsc_server_require__ = memoize(async (id) => {
		if (id.startsWith("$$preserve:")) {
			...
			const getOrCreateServerReference = (name) => {
				return target[name] ??= import_server_edge.registerServerReference(() => {
...
//#endregion
export { setRequireModule as a, loadServerAction as i, createServerDecodeClientManifest as n, require_server_edge as o, createServerManifest as r, require_react_dom_react_server as s, createClientManifest as t };
