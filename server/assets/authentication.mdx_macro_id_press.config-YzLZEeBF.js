...
//#region content/guides/authentication.mdx?macro_id=press.config.tsx%23guides
var import_jsx_runtime_react_server = require_jsx_runtime_react_server();
var frontmatter = {
	"title": "How do I add authentication?",
	"description": "Set up sign-up and sign-in with defineAuth, manage sessions, and read session state on the client."
};
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Adding authentication means declaring an auth surface once with `defineAuth` and letting the framework-owned engine wire up the flows, sessions, and route handlers behind it."
		},
		{
			"heading": "prerequisites",
			"content": "A project scaffolded with `kwiva new`"
		},
		{
			"heading": "prerequisites",
			"content": "A `users` model that declares the auth fields the engine maps onto"
		},
		{
			"heading": "prerequisites",
			"content": "Standard Schema validation available for input shaping"
		},
		{
			"heading": "add-a-users-model",
			"content": "The model declares the columns auth reads back, like `email`, `name`, and `role`. The engine adds its own managed columns, such as password hashes and session references, automatically at migration time:"
		},
		{
			"heading": "configure-defineauth",
			"content": "Sessions default to the `database` store with sliding expiry; switch to `redis` or `cookie` from the session config. Hooks such as `onSignUp` and `onSignIn` can dispatch work when users join. Enabling auth also registers the sign-up, sign-in, sign-out, and OAuth callback routes under `/auth/*`, plus `GET /auth/session` for the typed current session."
		},
		{
			"heading": "read-the-session-on-the-client",
			"content": "`useSession` exposes the signed-in user, a sign-out action, and a pending flag. Sessions load from the cookie during SSR and hydrate on the client:"
		},
		{
			"heading": "read-the-session-on-the-client",
			"content": "Provider screens (the ready-made `AuthScreen` pattern) can render the forms for you, or you can post to the generated `/auth/*` routes from your own pages."
		},
		{
			"heading": "protect-the-rest-of-your-app",
			"content": "With sessions flowing, lock down routes and pages — see How do I protect a route? and How do I add a policy?. A signed-in requirement on a route looks like this:"
		},
		{
			"heading": "verify-it-works",
			"content": "Start the dev server with `kwiva dev`."
		},
		{
			"heading": "verify-it-works",
			"content": "Sign up with `POST /auth/sign-up`, then `GET /auth/session` returns the signed-in user."
		},
		{
			"heading": "verify-it-works",
			"content": "Render `AuthStatus`: the user appears after sign-in and the sign-out button clears the session."
		},
		{
			"heading": "verify-it-works",
			"content": "Hit a `requireAuth` route without a cookie and the request returns `401`."
		},
		{
	...
	"headings": [
		...
		{
			"id": "add-a-users-model",
			"content": "Add a users model"
		},
		{
			"id": "configure-defineauth",
			"content": "Configure defineAuth"
		},
		{
			"id": "read-the-session-on-the-client",
			"content": "Read the session on the client"
		},
		{
			"id": "protect-the-rest-of-your-app",
			"content": "Protect the rest of your app"
		},
		{
			"id": "verify-it-works",
...
var toc = [
	...
	{
		depth: 2,
		url: "#add-a-users-model",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Add a users model" })
	},
	{
		depth: 2,
		url: "#configure-defineauth",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Configure defineAuth" })
	},
	{
		depth: 2,
		url: "#read-the-session-on-the-client",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Read the session on the client" })
	},
	{
		depth: 2,
		url: "#protect-the-rest-of-your-app",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Protect the rest of your app" })
	},
	{
		depth: 2,
		url: "#verify-it-works",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Adding authentication means declaring an auth surface once with ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "defineAuth" }),
			" and letting the framework-owned engine wire up the flows, sessions, and route handlers behind it."
		] }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: ["A project scaffolded with ", (0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "kwiva new" })] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"A ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "users" }),
				" model that declares the auth fields the engine maps onto"
			] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsx)(_components.li, { children: "Standard Schema validation available for input shaping" }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "add-a-users-model",
			children: "Add a users model"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"The model declares the columns auth reads back, like ",
			...
			". The engine adds its own managed columns, such as password hashes and session references, automatically at migration time:"
		] }),
		"\n",
				...
				(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime_react_server.jsx)(_components.span, {
							...
							children: "    oauth: { google: { clientId: "
						}),
						(0, import_jsx_runtime_react_server.jsx)(_components.span, {
							style: {
								"--shiki-light": "#6F42C1",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			...
			" from the session config. Hooks such as ",
			...
			" can dispatch work when users join. Enabling auth also registers the sign-up, sign-in, sign-out, and OAuth callback routes under ",
			...
			" for the typed current session."
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "read-the-session-on-the-client",
			children: "Read the session on the client"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "useSession" }), " exposes the signed-in user, a sign-out action, and a pending flag. Sessions load from the cookie during SSR and hydrate on the client:"] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			tabIndex: "0",
			title: "read-the-session-on-the-client.tsx",
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Provider screens (the ready-made ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "AuthScreen" }),
			" pattern) can render the forms for you, or you can post to the generated ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "/auth/*" }),
			" routes from your own pages."
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "protect-the-rest-of-your-app",
			children: "Protect the rest of your app"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"With sessions flowing, lock down routes and pages — see ",
			(0, import_jsx_runtime_react_server.jsx)(_components.a, {
				href: "/guides/protect-routes",
				children: "How do I protect a route?"
			}),
			" and ",
			(0, import_jsx_runtime_react_server.jsx)(_components.a, {
				href: "/guides/policies",
				children: "How do I add a policy?"
			}),
			". A signed-in requirement on a route looks like this:"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			...
			tabIndex: "0",
			title: "protect-the-rest-of-your-app.ts",
			icon: "<svg viewBox=\"0 0 24 24\"><path d=\"M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.033 5.033 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 27.72 27.72 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.441.58-.804 1.004-1.089a4.494 4.494 0 0 1 1.47-.629 7.536 7.536 0 0 1 1.77-.201zm-15.113.188h9.563v2.166H9.506v9.646H6.789v-9.646H3.375z\" fill=\"currentColor\" /></svg>",
			children: (0, import_jsx_runtime_react_server.jsx)(_components.code, { children: (0, import_jsx_runtime_react_server.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: "({ beforeHandle: requireAuth })"
					})
				]
			}) })
		}) }),
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"Render ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "AuthStatus" }),
				": the user appears after sign-in and the sign-out button clears the session."
			] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				"Hit a ",
				(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "requireAuth" }),
				" route without a cookie and the request returns ",
