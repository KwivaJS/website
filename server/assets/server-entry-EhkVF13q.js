...
import { n as press_config_default } from "./press.config-COrck8gL.js";
...
var toProcessRequest = (handleRequest) => async (req) => {
	...
	const renderUtils = createRenderUtils(temporaryReferences, renderToReadableStream, loadSsrEntryModule, "xzNNWhn-", void 0, debugId);
	let res;
	try {
...
var toProcessBuild = (handleBuild) => async ({ emitFile, unstable_registerPrunableFile }) => {
	const renderUtils = createRenderUtils(void 0, renderToReadableStream, loadSsrEntryModule, "xzNNWhn-");
	let fallbackHtml;
...
var modules = /* #__PURE__ */ Object.assign({
	"./pages/_layout.tsx": () => import("./_layout-Br9r21s4.js"),
