...
//#region content/guides/create-controller.mdx?macro_id=press.config.tsx%23guides
var import_jsx_runtime_react_server = require_jsx_runtime_react_server();
var frontmatter = {
	"title": "How do I create a controller?",
	"description": "Scaffold a controller with kwiva make:controller, define typed handlers with defineController, and verify your routes with curl."
};
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "This guide shows how to expose an HTTP API with `defineController`. A controller groups typed handlers — `get`, `post`, `put`, `delete` — under a single prefix, with per-route validation and permissions."
		},
		{
			"heading": "prerequisites",
			"content": "A Kwiva project with the `@kwiva/http` package installed"
		},
		{
			"heading": "prerequisites",
			"content": "A model to operate on (see create a model)"
		},
		{
			"heading": "prerequisites",
			"content": "The dev server available on `http://localhost:3000`"
		},
		{
			"heading": "generate-the-controller",
			"content": "`kwiva make:controller` scaffolds a controller file:"
		},
		{
			"heading": "generate-the-controller",
			"content": "This creates `src/app/http/controllers/posts.ts`."
		},
		{
			"heading": "define-handlers",
			"content": "Open the generated file and define your handlers. Each handler receives a typed context with `body`, `params`, `query`, and `session`:"
		},
		{
			"heading": "route-options",
			"content": "The third argument configures the route group: `prefix` mounts the controller at `/posts`, and `tags` flows into the OpenAPI spec. The per-route `permission` option gates each handler by policy — a missing session returns 401, a denied policy returns 403."
		},
		{
			"heading": "route-options",
			"content": "For custom actions beyond the resource verbs, add a handler on a sub-path:"
		},
		{
			"heading": "verify-it-works",
			"content": "With the dev server running, exercise the routes:"
		},
		{
			"heading": "verify-it-works",
			"content": "The create call returns the new record, and the list handler returns a paginated page of published posts. The routes also appear under `/openapi.json`."
		},
		{
			"heading": "related-documentation",
			"content": "Controllers — The `defineController` reference"
		},
		{
			"heading": "related-documentation",
			"content": "Your First API — Controller walkthrough"
		},
		{
			"heading": "related-documentation",
			"content": "Routes — Route conventions and generated endpoints"
		},
		{
			"heading": "related-documentation",
			"content": "Validation — Per-route Standard Schema"
		},
		{
			"heading": "related-documentation",
			"content": "Guards — `c.guard()` for route protection"
		}
	],
	"headings": [
		{
		...
		{
			"id": "generate-the-controller",
			"content": "Generate the controller"
		},
		{
			"id": "define-handlers",
			"content": "Define handlers"
		},
		{
			"id": "route-options",
...
var toc = [
	...
	{
		depth: 2,
		url: "#generate-the-controller",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Generate the controller" })
	},
	{
		depth: 2,
		url: "#define-handlers",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Define handlers" })
	},
	{
		depth: 2,
		url: "#route-options",
		title: (0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: "Route options" })
	},
	{
		depth: 2,
		url: "#verify-it-works",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"This guide shows how to expose an HTTP API with ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "defineController" }),
			". A controller groups typed handlers — ",
			...
			" — under a single prefix, with per-route validation and permissions."
		] }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: ["The dev server available on ", (0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "http://localhost:3000" })] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "generate-the-controller",
			children: "Generate the controller"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "kwiva make:controller" }), " scaffolds a controller file:"] }),
		"\n",
		...
		(0, import_jsx_runtime_react_server.jsx)(_components.h2, {
			id: "define-handlers",
			children: "Define handlers"
		}),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"Open the generated file and define your handlers. Each handler receives a typed context with ",
			...
			children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: "      authorId: session.user.id,"
					})
				}),
				"\n",
				(0, import_jsx_runtime_react_server.jsx)(_components.span, {
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			...
			" flows into the OpenAPI spec. The per-route ",
			(0, import_jsx_runtime_react_server.jsx)(_components.code, { children: "permission" }),
			" option gates each handler by policy — a missing session returns 401, a denied policy returns 403."
		] }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "For custom actions beyond the resource verbs, add a handler on a sub-path:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(_components.p, { children: "With the dev server running, exercise the routes:" }),
		"\n",
		(0, import_jsx_runtime_react_server.jsx)(import_jsx_runtime_react_server.Fragment, { children: (0, import_jsx_runtime_react_server.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime_react_server.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime_react_server.jsxs)(_components.span, {
					...
					children: [(0, import_jsx_runtime_react_server.jsx)(_components.span, {
						...
						children: " http://localhost:3000/posts/pst_123"
					})]
				})
			] })
		}) }),
		"\n",
		(0, import_jsx_runtime_react_server.jsxs)(_components.p, { children: [
			"The create call returns the new record, and the list handler returns a paginated page of published posts. The routes also appear under ",
		...
		(0, import_jsx_runtime_react_server.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.a, {
				...
				children: "Routes"
			}), " — Route conventions and generated endpoints"] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [(0, import_jsx_runtime_react_server.jsx)(_components.a, {
				href: "/docs/http/validation",
				children: "Validation"
			}), " — Per-route Standard Schema"] }),
			"\n",
			(0, import_jsx_runtime_react_server.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime_react_server.jsx)(_components.a, {
