...
import { $ as useIsoLayoutEffect, A as createChangeEventDetails, F as focusOut, G as triggerPress, I as imperativeAction, J as NOOP, Q as useRefWithInit, S as isHTMLElement, W as triggerHover, X as formatErrorMessage, Z as useStableCallback, n as useOpenChangeComplete, o as useAnimationFrame, q as EMPTY_OBJECT, r as useAnimationsFinished, s as useOnMount, u as useId, x as isElement, y as getWindow } from "./useTransitionStatus-CgpR1fP4.js";
import { n as useBaseUiId, r as useRenderElement } from "./stateAttributesMapping-B8mynGFP.js";
import { b as getTarget, d as inertValue, o as COMPOSITE_KEYS, t as Search, x as ownerDocument, y as contains } from "./search-moGbV3Yd.js";
import { t as useButton } from "./useButton-CmgotloM.js";
import { A as isVirtualPointerEvent, C as useFloatingTree, D as isMouseLikePointerType, E as require_shim, I as ios, S as useFloatingParentNodeId, T as fastComponentRef, _ as FloatingRootStore, a as PopupTriggerMap, b as FloatingTree, c as attachPreventUnmountOnClose, d as useImplicitActiveTrigger, f as useOpenStateTransitions, g as useTriggerDataForwarding, h as usePopupRootSync, i as popupStoreSelectors, l as createDefaultInitialFocus, m as usePopupRootStore, o as FOCUSABLE_POPUP_PROPS, p as usePopupInteractionProps, r as createInitialPopupStoreState, s as PopupHandleAttachment, u as createPopupOpenState, v as ReactStore, w as fastComponent, x as useFloatingNodeId, y as FloatingNode } from "./DialogStore-S_4PlVMb.js";
import { A as popupTransitionStateMapping, C as getTabbableBeforeElement, D as isTargetInsideEnabledTrigger, E as isInteractiveElement, M as triggerOpenStateMapping, O as isTypeableElement, S as getTabbableAfterElement, T as getNodeChildren, _ as useTimeout, a as useDismiss, b as getNextTabbable, f as POPUP_COLLISION_AVOIDANCE, g as Timeout, h as mergeCleanups, i as InternalBackdrop, j as pressableTriggerOpenStateMapping, k as popupStateMapping, l as CLICK_TRIGGER_IDENTIFIER, m as FocusGuard, n as useDialogRootContext, o as FloatingFocusManager, r as useScrollLock, s as FloatingPortal, u as DISABLED_TRANSITIONS_STYLE, w as isOutsideEvent } from "./DialogRootContext-DTwNcHms.js";
import { a as size, c as clamp, d as getAlignmentAxis, f as getAxisLength, h as getSideAxis, i as shift, l as evaluate, m as getSide, n as limitShift, o as useFloating$1, p as getPaddingObject, r as offset, s as autoUpdate, t as flip, u as getAlignment } from "./floating-ui.react-dom-DpBhZTYb.js";
...
import { i as useSearchContext, n as z } from "./dist-m51gyz8p.js";
...
__iconData$2.node;
var Airplay = createLucideIcon(__iconData$2);
//#endregion
...
*/
var PopoverTrigger$1 = fastComponentRef(function PopoverTrigger(componentProps, forwardedRef) {
...
//#endregion
export { useFloating as C, useHoverInteractionSharedState as S, useClick as T, safePolygon as _, isLinkItemActive as a, applySafePolygonPointerEventsMutation as b, SearchTrigger as c, PopoverContent as d, PopoverTrigger as f, DEFAULT_SIDES as g, useAnchorPositioningWithHook as h, isLayoutTabActive as i, DialogTrigger as l, getDisabledMountTransitionStyles as m, baseSlots as n, useLinkItems as o, usePositioner as p, getLayoutTabs as r, isActive as s, LinkItem as t, Popover as u, useHoverReferenceInteraction as v, useFloatingRootContext as w, clearSafePolygonPointerEventsMutation as x, useHoverFloatingInteraction as y };
