import { i as __toESM, r as __require } from "./rolldown-runtime-B4iAMlE-.js";
import { t as require_jsx_runtime } from "./jsx-runtime-BqLYtsoi.js";
import { c as SearchDialogInput, i as SearchDialogContent, l as SearchDialogList, n as SearchDialog, o as SearchDialogHeader, r as SearchDialogClose, s as SearchDialogIcon, t as useDocsSearch, u as SearchDialogOverlay } from "./client-CAOIt50h.js";
...
var flexsearch_bundle_module_min_default = {
	Index: T,
	Charset: va,
	Encoder: ka,
	Document: Na,
...
//#endregion
//#region node_modules/fumadocs-core/dist/utils-Bvy3V-fv.js
...
function createDocument(options) {
	return new flexsearch_bundle_module_min_default.Document({
		tokenize: "full",
		...options,
		document: {
			id: "id",
...
//#endregion
//#region node_modules/fumadocs-core/dist/search/client/flexsearch-static.js
...
function flexsearchStaticClient(options = {}) {
	const { from = join("/", "/api/search"), locale = "", tag } = options;
...
//#endregion
//#region \0virtual:vite-rsc/client-references/group/facade:node_modules/fumapress/dist/components/flexsearch-static.js
var export_16c5e792d2ee = { default: DefaultSearchDialog };
//#endregion
export { export_16c5e792d2ee };
