...
import { n as useOpenChangeComplete } from "./useTransitionStatus-CgpR1fP4.js";
import { r as useRenderElement } from "./stateAttributesMapping-B8mynGFP.js";
import { o as COMPOSITE_KEYS, t as Search } from "./search-moGbV3Yd.js";
import { l as createDefaultInitialFocus, o as FOCUSABLE_POPUP_PROPS, w as fastComponent } from "./DialogStore-S_4PlVMb.js";
import { A as popupTransitionStateMapping, n as useDialogRootContext, o as FloatingFocusManager } from "./DialogRootContext-DTwNcHms.js";
import { t as createLucideIcon } from "./createLucideIcon-CUS0Rvh9.js";
import { n as ChevronRight, t as e } from "./dist-D3b8pzgn.js";
import { a as useRouter, c as useTranslations, o as T } from "./framework-BVFfi5Qn.js";
import { _ as parse$1, a as zwitch, c as pointStart, d as html, f as svg, i as visit, l as parse, m as normalize, n as esm_default, p as find, s as pointEnd, t as createMarkdownRenderer, u as stringify$1, v as stringify } from "./md-DMu-OVRD.js";
...
__iconData.node;
var Hash = createLucideIcon(__iconData);
//#endregion
...
function SearchDialogContent({ ref, children, className, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPopup, {
...
function useDocsSearch(clientOptions, customDeps) {
	...
	if ("type" in clientRest) switch (clientRest.type) {
		case "fetch":
			client = import("./fetch-w0kAi-84.js").then((mod) => mod.fetchClient(clientRest));
			break;
		case "algolia":
			client = import("./algolia-CxGJj-C_.js").then((mod) => mod.algoliaClient(clientRest));
			break;
		case "orama-cloud":
			client = import("./orama-cloud-aVa8axZ9.js").then((mod) => mod.oramaCloudClient(clientRest));
			break;
		case "orama-cloud-legacy":
			client = import("./orama-cloud-legacy-oOC_gKo8.js").then((mod) => mod.oramaCloudLegacyClient(clientRest));
			break;
		case "mixedbread":
			client = import("./mixedbread-WSXT_DPS.js").then((mod) => mod.mixedbreadClient(clientRest));
			break;
		case "static":
			client = import("./orama-static-CnJpRiZ9.js").then((mod) => mod.staticClient(clientRest));
			break;
	...
	const [activeDeps, setActiveDeps] = (0, import_react.useState)(null);
	const activeTaskRef = (0, import_react.useRef)(null);
...
//#endregion
export { SearchDialogFooter as a, SearchDialogInput as c, TagsList as d, TagsListItem as f, SearchDialogContent as i, SearchDialogList as l, SearchDialog as n, SearchDialogHeader as o, SearchDialogClose as r, SearchDialogIcon as s, useDocsSearch as t, SearchDialogOverlay as u };
