import { i as __toESM, t as __commonJSMin } from "./assets/rolldown-runtime-B4iAMlE-.js";
import { t as require_jsx_runtime } from "./assets/jsx-runtime-BqLYtsoi.js";
import { t as require_react } from "./assets/react-SLAb4Nsi.js";
...
function createFromReadableStream$1(stream, options = {}) {
...
var client_references_default = {
	"4851f1db4d2a": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_4851f1db4d2a;
	},
	"becc1a081aff": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_becc1a081aff;
	},
	"0817f5b3b49f": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_0817f5b3b49f;
	},
	"9c1899cbc660": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_9c1899cbc660;
	},
	"5c57a93f55ec": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_5c57a93f55ec;
	},
	"fbfe50abbf7b": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_fbfe50abbf7b;
	},
	"e70dc53bce46": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_e70dc53bce46;
	},
	"95bdd8cb34e3": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_95bdd8cb34e3;
	},
	"3bd706baf759": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_3bd706baf759;
	},
	"edf18fee0631": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_edf18fee0631;
	},
	"7ce05cec18ef": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_7ce05cec18ef;
	},
	"859200a8131f": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_859200a8131f;
	},
	"4e8efe524788": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_4e8efe524788;
	},
	"92754d11c7d6": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_92754d11c7d6;
	},
	"47f03de92207": async () => {
		return (await import("./assets/dist-CgSsES-3.js")).export_47f03de92207;
	},
	"62ec5df3f7b4": async () => {
		return (await import("./assets/default-CQ_9mbVn.js")).export_62ec5df3f7b4;
	},
	"565c9086adf4": async () => {
		return (await import("./assets/glass-ro2eV016.js")).export_565c9086adf4;
	},
	"143db4d99239": async () => {
		return (await import("./assets/client-Df5vrIR9.js")).export_143db4d99239;
	},
	"c1a625c0fb46": async () => {
		return (await import("./assets/docs-dHhsKD9g.js")).export_c1a625c0fb46;
	},
	"40036365f8f4": async () => {
		return (await import("./assets/docs-dHhsKD9g.js")).export_40036365f8f4;
	},
	"1015cf8d22ee": async () => {
		return (await import("./assets/not-found-Z7_06R8s.js")).export_1015cf8d22ee;
	},
	"5ea31104ddfe": async () => {
		return (await import("./assets/client-Bw9Ca_FP.js")).export_5ea31104ddfe;
	},
	"2dd9a6bf4c04": async () => {
		return (await import("./assets/client-B3YdQbGS.js")).export_2dd9a6bf4c04;
	},
	"3596b55eceb0": async () => {
		return (await import("./assets/client-B3YdQbGS.js")).export_3596b55eceb0;
	},
	"bbc501ebc8d1": async () => {
		return (await import("./assets/client-B3YdQbGS.js")).export_bbc501ebc8d1;
	},
	"16c5e792d2ee": async () => {
		return (await import("./assets/flexsearch-static-DpsWGGIj.js")).export_16c5e792d2ee;
	},
	"79245c25971e": async () => {
		return (await import("./assets/root-Bpuv0JaB.js")).export_79245c25971e;
	},
	"fe45b661386f": async () => {
		return (await import("./assets/self-hosted-CumrlWtW.js")).export_fe45b661386f;
	},
	"339f946bc456": async () => {
		return (await import("./assets/Icon-BFBRjfJD.js")).export_339f946bc456;
	},
	"847a2b1045ef": async () => {
		return (await import("./assets/client-Cm_i8p1F.js")).export_847a2b1045ef;
	},
	"6d786e16fc6b": async () => {
		return (await import("./assets/client-Cm_i8p1F.js")).export_6d786e16fc6b;
	},
	"a9c69bc3d36c": async () => {
		return (await import("./assets/pages-DhA0PHvU.js")).export_a9c69bc3d36c;
	},
	"703084a04969": async () => {
		return (await import("./assets/pages-DhA0PHvU.js")).export_703084a04969;
	},
	"ed5a4c0e3c3f": async () => {
		return (await import("./assets/pages-DhA0PHvU.js")).export_ed5a4c0e3c3f;
	},
	"3c6fb9a1e938": async () => {
		return (await import("./assets/pages-DhA0PHvU.js")).export_3c6fb9a1e938;
	}
};
//#endregion
...
function getClientEntryUrl() {
	...
	if (!url) throw new Error(`[vite-rsc] getClientEntryUrl() cannot be used with the 'customClientEntry' option`);
	return url;
}
initialize();
function initialize() {
...
//#endregion
//#region node_modules/rsc-html-stream/server.js
...
function injectRSCPayload(rscStream, options) {
	...
	function flushBufferedChunks(controller) {
		for (let chunk of buffered) {
			...
			controller.enqueue(encoder$1.encode(buf));
		}
		let remaining = decoder.decode();
		if (remaining.length) {
			if (remaining.endsWith(trailer)) remaining = remaining.slice(0, -14);
			controller.enqueue(encoder$1.encode(remaining));
		}
		buffered.length = 0;
		timeout = null;
	}
	return new TransformStream({
		...
		async flush(controller) {
			...
			controller.enqueue(encoder$1.encode(trailer));
		}
	});
}
...
function writeChunk(chunk, controller, nonce) {
	controller.enqueue(encoder$1.encode(`<script${nonce ? ` nonce="${nonce}"` : ""}>${escapeScript(`(self.__FLIGHT_DATA||=[]).push(${chunk})`)}<\/script>`));
}
function escapeScript(script) {
	return script.replace(/<!--/g, "<\\!--").replace(/<\/(script)/gi, "</\\$1");
}
//#endregion
//#region \0virtual:vite-rsc-waku/html-shell
var html_shell_default = "<html><body></body></html>";
//#endregion
...
//#endregion
//#region node_modules/waku/dist/lib/utils/initial-rsc.js
var createInitialRscEntryCode = (debugId) => `
  (() => {
    const e = {};
...
var { createFromFetch, encodeReply, createTemporaryReferenceSet } = client_default;
...
var MergeElementsContext = /*#__PURE__*/ (0, import_react.createContext)(() => {
...
/** Render the client children passed to the enclosing Slot. */ var Children_UNSTABLE = () => (0, import_react.use)(ChildrenContext);
...
* ```
*/ var Slot_UNSTABLE = ({ id, children }) => {
	const elementsPromise = useElementsPromise_UNSTABLE();
	const elements = (0, import_react.use)(elementsPromise);
...
var INTERNAL_ServerRoot = ({ elementsPromise, children }) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)(MergeElementsContext, {
	value: async () => ({}),
...
function createBootstrapScriptContent(entryUrl) {
	const entryImport = `import(${JSON.stringify(entryUrl)})`;
	if (!getRecoveryBuildId()) return `${entryImport};`;
...
function getBootstrapPreamble(options) {
	return `
    ${getVersionSkewRecoveryCode()}
    ${options.hydrate ? "globalThis.__WAKU_HYDRATE__ = true;" : ""}
    ${options.initialRsc ? `
    globalThis.__WAKU_INITIAL_RSC__ = ${createInitialRscEntryCode(options.debugId)};
    ` : ""}
...
function batchReadableStream(input) {
	const buffer = [];
	let timer;
	...
	return input.pipeThrough(new TransformStream({
		transform(chunk, controller) {
			buffer.push(chunk);
			if (!timer) timer = setTimeout(() => flushBuffer(controller));
		},
		flush(controller) {
...
//#endregion
//#region node_modules/waku/dist/lib/vite-rsc/ssr.js
function createFromReadableStream(stream) {
	return createFromReadableStream$1(stream);
}
var renderHtmlStream = async (rscStream, rscHtmlStream, options) => {
	...
	function SsrRoot() {
		...
		return /*#__PURE__*/ (0, import_jsx_runtime.jsx)(INTERNAL_ServerRoot, {
			elementsPromise,
			children: (0, import_react.use)(htmlPromise)
		});
	}
	const bootstrapScriptContent = createBootstrapScriptContent(getClientEntryUrl());
	let htmlStream;
	let status;
	try {
		htmlStream = await (0, import_server_edge.renderToReadableStream)(/*#__PURE__*/ (0, import_jsx_runtime.jsx)(SsrRoot, {}), {
			...
			onError: (e) => {
				...
				console.error("[SSR Error]", sanitizeLog(import_react.captureOwnerStack?.() || ""), "\n", sanitizeLog(e));
			},
		...
		if (info?.location) throw e;
		status = info?.status || 500;
		htmlStream = await (0, import_server_edge.renderToReadableStream)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("html", { children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)("body", {}) }), {
			bootstrapScriptContent: getBootstrapPreamble({
				hydrate: false,
				initialRsc: true
			}) + bootstrapScriptContent + (options.extraScriptContent || ""),
	...
	return {
		stream: htmlStream.pipeThrough(injectRSCPayload(batchReadableStream(stream2), options.nonce ? { nonce: options.nonce } : {})),
		status
	};
};
async function renderHtmlFallback() {
	const bootstrapScriptContent = createBootstrapScriptContent(getClientEntryUrl());
	return html_shell_default.replace("</body>", () => `<script>${getBootstrapPreamble({
		hydrate: false,
		initialRsc: false
	})}${bootstrapScriptContent}<\/script></body>`);
}
//#endregion
export { renderHtmlFallback as INTERNAL_renderHtmlFallback, renderHtmlStream as INTERNAL_renderHtmlStream, Slot_UNSTABLE as n, require_react_dom as r, Children_UNSTABLE as t };
